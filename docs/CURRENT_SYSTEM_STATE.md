...
Revision: CB-ARCH-20260906-001
Recorded: 2026-09-06T18:30:00.000Z
...
- Production Publish is a user action; git `CB-BUILD-20260906-001` is not `PROD_SYNC` until that host serves this `BUILD_ID`.
