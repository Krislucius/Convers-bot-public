...
Architecture `CB-ARCH-20260908-002` · Build `CB-BUILD-20260908-005`  
...
Git: `main` → `origin` `https://github.com/Krislucius/Convers-bot-public.git`. Release tag `CB-BUILD-20260907-001`. See [docs/GIT.md](docs/GIT.md).
