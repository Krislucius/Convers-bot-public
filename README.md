...
Architecture `CB-ARCH-20260906-002` · Build `CB-BUILD-20260906-002`  
...
Git: `main` → `origin` `https://github.com/Krislucius/Convers-bot-public.git`. Release tag `CB-BUILD-20260906-002`. See [docs/GIT.md](docs/GIT.md).
