...
Architecture `CB-ARCH-20260906-001` · Build `CB-BUILD-20260906-001`  
...
Git: `main` → `origin` `https://github.com/Krislucius/Convers-bot-public.git`. Release tag `CB-BUILD-20260906-001`. See [docs/GIT.md](docs/GIT.md).
