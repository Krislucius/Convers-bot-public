...
Architecture `CB-ARCH-20260901-002` · Build `CB-BUILD-20260904-020`  
...
Git: `main` → `origin` `https://github.com/Krislucius/Convers-bot-public.git`. Release tag `CB-BUILD-20260904-020`. See [docs/GIT.md](docs/GIT.md).
