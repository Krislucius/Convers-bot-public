...
test("applied migrations live in the globbed directory and auth/ stays a template copy", () => {
  ...
  assert.deepEqual(
    ...
    ["0001_auth.sql", "0002_app.sql", "0003_task_modes.sql", "0004_project_files.sql", "0005_evidence_ledger.sql", "0006_closed_loop.sql", "0007_provider_budget.sql", "0008_dynamic_council.sql"],
  );
